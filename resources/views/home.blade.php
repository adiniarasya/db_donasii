...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet"
    href="{{ asset('AdminLTE/plugins/bootstrap/css/bootstrap.min.css') }}">
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
    ...
    <div class="container">
        ...
        <div>
            ...
            <a href="{{ route('login') }}"
            class="btn btn-outline-light btn-custom mr-2">
                Login
            </a>
    ...
    <div class="row min-vh-100 align-items-center">
        ...
        <div class="col-lg-6" data-aos="fade-right">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('register') }}"
                class="btn btn-light btn-lg btn-custom mr-2">
        ...
        data-aos="fade-left">
            ...
            <img
            src="https://cdn-icons-png.flaticon.com/512/2544/2544086.png"
            class="img-fluid"
            style="max-width:80%;">
